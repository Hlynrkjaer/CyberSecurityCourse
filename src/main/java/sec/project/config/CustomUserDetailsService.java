...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public void init() {
        ...
        this.accountDetails.put("Wardruna","fh2T[_6H h9ZfHJWn%pFxA_UP\"A^ym2`N+{3ge_'2&\\V~dFVAP*}Q/M");
        this.accountDetails.put("Ilmarinen",";.;vmRh>Xd'5<rZZ[5uBHgcHs3G`c7WBRe3*%Tw]y&'cDL-Qe<HkV:Z9#");
        this.accountDetails.put("Karhu","d'Y].=;msd:)fg)a<dzN{_~[`V5bj.S_fAe4&)U*/~m>Y,37>}3K'jb47^\\dds*m");
